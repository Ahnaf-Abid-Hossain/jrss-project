...
def modify_docx(file_path):
    ...
    if os.path.isfile(file_path) and file_path.lower().endswith(".pdf"):
        # The file is a PDF
        print(f"The file at {file_path} is a PDF.")
        base_filename = os.path.splitext(file_path)[0]
        
        # Construct the new filename with the ".docx" extension
        docx_filename = base_filename + '.docx'

        # Perform the conversion
        # pdf2docx.convert(pdf_filename, docx_filename)
        ...
        doc.sections.different_first_page_header_footer = False
        ...
        slogan_run.add_picture("JRSS_FBanner.png", width=Inches(4))
